  ...
  var i = function () {
    ...
    a = function () {
      var i = $(".page-quick-sidebar-wrapper"),
        ...
        e = function () {
          var e,
            t = i.find(".page-quick-sidebar-chat-users");
          ...
          var r = a.find(".page-quick-sidebar-chat-user-messages"),
            s =
              e - a.find(".page-quick-sidebar-chat-user-form").outerHeight(!0);
      ...
      e(),
        ...
        i
          .find(
            ".page-quick-sidebar-chat-user .page-quick-sidebar-back-to-list"
          )
          .click(function () {
    ...
    e = function () {
      var i = $(".page-quick-sidebar-wrapper"),
        a = function () {
          var a,
            e = i.find(".page-quick-sidebar-alerts-list");
    ...
    t = function () {
      var i = $(".page-quick-sidebar-wrapper"),
        a = function () {
          var a,
            e = i.find(".page-quick-sidebar-settings-list");
          (a =
            i.height() -
            80 -
            i.find(".nav-justified > .nav-tabs").outerHeight()),
            App.destroySlimScroll(e),
            e.attr("data-height", a),
            App.initSlimScroll(e);
        };
